...
-   [Folder Organization](#folder-organization)
    ...
    -   [./chipKIT/hardware/pic32/x.x.x/cores/pic32](#user-content-chipkithardwarepic32x.x.xcorespic32)
    -   [./chipKIT/hardware/pic32/x.x.x/libraries](#user-content-chipkithardwarepic32x.x.xlibraries)
    -   [./chipKIT/hardware/pic32/x.x.x/variants](#user-content-chipkithardwarepic32x.x.xvariants)
-   [Key Files](#key-files)
...
The following folder locations are significant to the board variant mechanism. x.x.x represents the chipKIT core version number for example ./hardware/pic32/1.3.0/. The location of these files may vary based on how you installed chipKIT core package. You might try looking in C:\\Users\\\[YOUR_NAME\]\\AppData\\Local\\Arduino15\\packages\\ if you have installed through the Arduino IDE Boards Manager.
