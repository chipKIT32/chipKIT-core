...
/* Function :  USB_EyePatternDisable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EyePatternDisable function.
*/
...
/* Function :  USB_EyePatternEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EyePatternEnable function.
*/
...
/* Function :  USB_ExistsEyePattern_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_ExistsEyePattern function.
*/
