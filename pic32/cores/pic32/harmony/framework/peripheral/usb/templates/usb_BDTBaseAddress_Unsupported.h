...
/* Function :  USB_BDTBaseAddressGet_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_BDTBaseAddressGet function.
*/
...
/* Function :  USB_BDTBaseAddressSet_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_BDTBaseAddressSet function.
*/
...
/* Function :  USB_ExistsBDTBaseAddress_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_ExistsBDTBaseAddress function.
*/
