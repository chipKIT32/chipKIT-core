...
/* Function :  USB_EPnRxEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnRxEnable function.
*/
...
/* Function :  USB_EPnRxDisable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnRxDisable function.
*/
...
/* Function :  USB_EPnTxEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnTxEnable function.
*/
...
/* Function :  USB_EPnTxDisable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnTxDisable function.
*/
...
/* Function :  USB_EPnHandshakeEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnHandshakeEnable function.
*/
...
/* Function :  USB_EPnHandshakeDisable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnHandshakeDisable function.
*/
...
/* Function :  USB_EPnControlTransferEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnControlTransferEnable function.
*/
...
/* Function :  USB_EPnControlTransferDisable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnControlTransferDisable function.
*/
...
/* Function :  USB_EPnIsStalled_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnIsStalled function.
*/
...
/* Function :  USB_EPnStallClear_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_EPnStallClear function.
*/
...
/* Function :  USB_ExistsEPnRxEnable_Unsupported
  ...
  Description:
    This template implements the Unsupported variant of the PLIB_USB_ExistsEPnRxEnable function.
*/
