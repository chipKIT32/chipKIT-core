...
typedef enum {
    ...
    INT_SOURCE_PARALLEL_PORT_ERROR = 62,
    ...
    INT_SOURCE_USART_4_ERROR = 63,
    INT_SOURCE_USART_4_RECEIVE = 64,
    INT_SOURCE_USART_4_TRANSMIT = 65,
    INT_SOURCE_I2C_4_ERROR = 37,
    INT_SOURCE_I2C_4_SLAVE = 38,
    INT_SOURCE_I2C_5_MASTER = 42,
    INT_SOURCE_USART_5_ERROR = 69,
    INT_SOURCE_USART_5_RECEIVE = 70,
    INT_SOURCE_USART_5_TRANSMIT = 71,
    INT_SOURCE_I2C_5_SLAVE = 41,
    INT_SOURCE_USART_6_ERROR = 66,
    INT_SOURCE_USART_6_RECEIVE = 67,
    INT_SOURCE_USART_6_TRANSMIT = 68,
    INT_SOURCE_CLOCK_MONITOR = 46,
    INT_SOURCE_RTCC = 47,
    INT_SOURCE_FLASH_CONTROL = 52,
