...
PLIB_TEMPLATE void OSC_SysClockSelect_Mz( OSC_MODULE_ID index , OSC_SYS_TYPE newOsc )
{
	...
	{
            _SFR_BIT_SET( _OSC_OSC_SYSPLL_INPUT_SOURCE_CLOCK_VREG(index),
                        _OSC_OSC_SYSPLL_INPUT_SOURCE_CLOCK_POS(index) );
	}
	else if ( newOsc == OSC_PRIMARY_WITH_PLL )
	{
            _SFR_BIT_CLEAR( _OSC_OSC_SYSPLL_INPUT_SOURCE_CLOCK_VREG(index),
                    _OSC_OSC_SYSPLL_INPUT_SOURCE_CLOCK_POS(index) );
	...
	_SFR_FIELD_WRITE(_OSC_OSC_SELECTMZ_VREG(index),
					 _OSC_OSC_SELECTMZ_MASK(index),
					 _OSC_OSC_SELECTMZ_POS(index) ,
					 newOsc);
