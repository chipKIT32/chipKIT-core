...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_VREG(index)

  MASKs: 
    _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_MASK(index)

  POSs: 
    _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_POS(index)

  LENs: 
    _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_LEN(index)
...
{
    _SFR_FIELD_WRITE(_OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_VREG(index),
                     _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_MASK(index),
                     _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_POS(index) ,
                     startupOsc );
}
...
{
    return (OSC_SLEEP_TO_STARTUP_CLK_TYPE)_SFR_FIELD_READ(_OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_VREG(index),
                           _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_MASK(index),
                           _OSC_SLEEP_TO_SPEED_STARTUP_CONTROL_POS(index) );
}
