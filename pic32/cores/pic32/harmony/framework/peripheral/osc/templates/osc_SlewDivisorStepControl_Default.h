...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_VREG(index)

  MASKs: 
    _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_MASK(index)

  POSs: 
    _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_POS(index)

  LENs: 
    _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_LEN(index)
...
{
    _SFR_FIELD_WRITE(_OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_VREG(index),
						 _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_MASK(index),
						 _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_POS(index) ,
						  slewSteps );
}
...
{
    return _SFR_FIELD_READ(_OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_VREG(index),
						 _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_MASK(index),
						 _OSC_OSC_SLEW_DIVISOR_STEP_CONTROL_POS(index) );
}
