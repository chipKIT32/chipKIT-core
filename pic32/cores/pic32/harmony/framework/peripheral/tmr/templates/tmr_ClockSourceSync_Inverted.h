...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _TMR_CLOCK_SOURCE_SYNC_INVERTED_VREG(index)

  MASKs: 
    _TMR_CLOCK_SOURCE_SYNC_INVERTED_MASK(index)

  POSs: 
    _TMR_CLOCK_SOURCE_SYNC_INVERTED_POS(index)

  LENs: 
    _TMR_CLOCK_SOURCE_SYNC_INVERTED_LEN(index)
...
{
    _SFR_BIT_SET( _TMR_CLOCK_SOURCE_SYNC_INVERTED_VREG( index ),
                  _TMR_CLOCK_SOURCE_SYNC_INVERTED_POS( index ) );
}
...
{
    _SFR_BIT_CLEAR( _TMR_CLOCK_SOURCE_SYNC_INVERTED_VREG( index ),
                    _TMR_CLOCK_SOURCE_SYNC_INVERTED_POS( index ) );
}
